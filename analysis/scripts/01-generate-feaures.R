...
subset_number <- 100000 ## # of cells (rows) to include in analysis
...
CD.Ig.markers <- colnames(dat)[grepl("CD|Ig", colnames(dat))]
...
data.input <- dat.clean %>%
  dplyr::select(all_of(relevant_features))
##########
## MAIN ##
##########
